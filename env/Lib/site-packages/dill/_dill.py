...
try:
    ...
    ) = PyBufferedReaderType = PyBufferedWriterType = None
...
class Pickler(StockPickler):
    ...
    dispatch: typing.Dict[
        type, typing.Callable[[Pickler, typing.Any], None]
        ...
        if m.case(
            ...
            if CODE_VERSION == (3, 11):
                return CodeType(
                    ...
                    *args[7:14],
                    args[14].encode()
                    if hasattr(args[14], "encode")
                    else args[14],  # linetable
                    args[15].encode()
                    if hasattr(args[15], "encode")
                    else args[15],  # exceptiontable
                    args[16],
                    args[17],
                )
            fields = m.fields
        # Python 3.10 or 3.8/3.9 (16 members)
            ...
            if CODE_VERSION == (3, 10) or CODE_VERSION == (3, 8):
                return CodeType(
                    ...
                    *args[7:13],
                    args[13].encode()
                    if hasattr(args[13], "encode")
                    else args[13],  # lnotab/linetable
                    args[14],
                    args[15],
                )
            fields = m.fields
